...
export const BLOCK_SET_DESCRIPTION = 'BLOCK_SET_DESCRIPTION';
...
export const BLOCK_SET_FIXED = 'BLOCK_SET_FIXED';
...
export const BLOCK_ATTRIBUTE = 'BLOCK_ATTRIBUTE';
export const BLOCK_SET_JOB_ID = 'BLOCK_SET_JOB_ID';

export const INVENTORY_SEARCH = 'INVENTORY_SEARCH';
export const INVENTORY_SEARCH_RESET = 'INVENTORY_SEARCH_RESET';
...
export const PROJECT_STASH = 'PROJECT_STASH';
export const PROJECT_LOAD = 'PROJECT_LOAD';
export const PROJECT_BEFORE_OPEN = 'PROJECT_BEFORE_OPEN';
...
export const PROJECT_SET_KEYWORDS = 'PROJECT_SET_KEYWORDS';
export const PROJECT_SETPALETTE = 'PROJECT_SETPALETTE';
...
export const INSPECTOR_SELECT_TAB = 'INSPECTOR_SELECT_TAB';
...
export const UI_SHOW_PUBLISH_DIALOG = 'UI_SHOW_PUBLISH_DIALOG';
export const UI_SHOW_UNPUBLISH_DIALOG = 'UI_SHOW_UNPUBLISH_DIALOG';
export const UI_SHOW_PROJECT_DELETE_DIALOG = 'UI_SHOW_PROJECT_DELETE_DIALOG';
export const UI_FEEDBACK_TEXT_CHANGE = 'UI_FEEDBACK_TEXT_CHANGE';
export const UI_FEEDBACK_ANON_TOGGLE = 'UI_FEEDBACK_ANON_TOGGLE';
export const UI_FEEDBACK_TO_INDEX_CHANGE = 'UI_FEEDBACK_TO_INDEX_CHANGE';
export const UI_FEEDBACK_STARS_CHANGE = 'UI_FEEDBACK_STARS_CHANGE';
export const UI_FEEDBACK_RECOMMEND_CHANGE = 'UI_FEEDBACK_RECOMMEND_CHANGE';
...
export const SNAPSHOT_PROJECT = 'SNAPSHOT_PROJECT';
export const SNAPSHOT_RETRIEVE = 'SNAPSHOT_RETRIEVE';
export const SNAPSHOT_LIST = 'SNAPSHOT_LIST';
export const SNAPSHOT_QUERY = 'SNAPSHOT_QUERY';

export const COMMONS_PUBLISH = 'COMMONS_PUBLISH';
export const COMMONS_RETRIEVE_PROJECT = 'COMMONS_RETRIEVE_PROJECT';
export const COMMONS_RETRIEVE_PROJECT_VERSIONS = 'COMMONS_RETRIEVE_PROJECT_VERSIONS';
export const COMMONS_QUERY = 'COMMONS_QUERY';
export const COMMONS_UNPUBLISH = 'COMMONS_UNPUBLISH';
